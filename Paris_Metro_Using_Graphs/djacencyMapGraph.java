...
// MAYBE MAKE a vertex subclass, edge subcclass    				MAKE A getVertex method
public class djacencyMapGraph<V, E> implements Graph<V, E> {   //HAVE TO MAKE IT DIRECTED
	...
	private class InnerVertex<V> implements Vertex<V>{
		...
		public InnerVertex(V elem) {
			element = elem;
			outgoing = new HashMap<>();  // NOT CORRECT MAYBE
